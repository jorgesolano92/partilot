...
<p class="contract-section-title">Datos de la Entidad</p>
<table class="contract-annex-table">
    <tr><th>Nombre de la Entidad</th><td>{{ $entityName }}</td></tr>
    ...
    <tr><th>Administración de Lotería vinculada</th><td>{{ $administrationLinked }}</td></tr>
</table>

<p class="contract-section-title">Datos del Gestor Responsable firmante</p>
<table class="contract-annex-table">
